module.exports = function (grunt) {
    ...
    grunt.registerTask('qa-local', ['karma:devlocal', 'jshint', 'plato']);
    ...
    grunt.registerTask('start', ['clean:start', 'clean:bower', 'clean:libs', 'bower', 'artifactory:snapshot', 'artifactory:release', 'bower_clean', 'copy:artifactoryLibs', 'copy:libs', 'clean:libs']);
