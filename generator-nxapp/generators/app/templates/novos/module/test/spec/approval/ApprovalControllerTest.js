...
describe('[Controller] ApprovalController', function () {
    ...
    beforeEach(function () {
        module('testMockRun', 'approval', 'nxTemplatesTest');
    ...
    it('Deve filtrar os Approval', function () {
        //Given
        $httpBackend.expect('GET', /.*/).respond(
            retorno
        );
    ...
    it('Deve não trazer Approval', function () {
        //Given
        $httpBackend.expect('GET', /.*/).respond(
            retorno
        );
